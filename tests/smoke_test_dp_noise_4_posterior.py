...
tracker = PrivacyBudgetTracker(
    total_epsilon=1.0, total_delta=1e-4, participant_ids=["participant_1"]
)
...
tracker2 = PrivacyBudgetTracker(
    total_epsilon=0.1, total_delta=1e-4, participant_ids=["participant_1"]
)
